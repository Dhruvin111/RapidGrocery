						...
						<div class="table-wrapper table-responsive">
							<table class="table">
								...
								<c:if test="${!empty users}">
									...
									<c:if test="${user.userTId == 5}">
										<tbody>
											<tr>
												<td class="min-width"><c:out
														value="${user.userMasterId}" /></td>
												<td class="min-width"><c:out
														value="${user.userMasterFirstName}" /></td>
												<td class="min-width"><c:out
														value="${user.userMasterLastName}" /></td>
												<td class="min-width"><c:out
														value="${user.userEmailId}" /></td>
												<td class="min-width"><c:out
												...
												<td class="min-width"><c:out value="${user.userDOB}" />
												</td>												
...
<%-- 												<td class="min-width"><c:if test="${(user.userTId == 2) || (user.userTId ==4)}"> --%>
<%-- 												<c:out value="${user.userSalary}" /> --%>


<%-- 													<c:if test="${user.isPaid == 'NotPaid'}"> --%>

<!-- 														<a class="btn btn-paid btn-success active " -->
<%-- 															href="updatePaidSalary?userSalaryId=${user.userSalaryId}"> --%>


<!-- 															Pay </a> -->

<%-- 													</c:if> <c:if test="${user.isPaid == 'Paid'}"> --%>
