			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card-style mb-30">
						<h6 class="mb-10">User Listing</h6>
						<div class="table-wrapper table-responsive">
							<table class="table">
								<thead>
									<tr>
										<th><h6>User ID</h6></th>
										<th><h6>Salary ID</h6></th>
										<th><h6>Salary</h6></th>
										<th><h6>Salary Date</h6></th>
										<th><h6>Paid</h6></th>
										...
										<tbody>
											<tr>
												<td class="min-width"><c:out
														value="${salary.userMasterId}" /></td>
												<td class="min-width"><c:out
														value="${salary.userSalaryId}" /></td>
												<td class="min-width"><c:out
														value="${salary.userSalary}" /></td>
														<td class="min-width"><c:out
														value="${salary.userSalaryDate}" /></td>
												<td class="min-width">
										 <td class="min-width " id="togglec">
										
															
										 <a  class="btn btn-paid btn-danger  disabled" style=" pointer-events: none;"
													href="updatePaidUser?userMasterId=${salary.userMasterId}"
													class="text-light"> <c:out value="${salary.isPaid}" /></a>


												</td> 
												
												<%-- 
												<td class="min-width"><c:out value="${user.userSalary}" />
													
														
															<a class="btn btn-paid btn-success active disabled" 
																href="addSalaryUser?userMasterId=${user.userMasterId}" >
															Paid  </a>
												...
												<%-- <td class="min-width " id="togglec"><a
													href="updateActiveUser?userMasterId=${user.userMasterId}"
													class="text-danger"> <c:out value="${user.isActive}" /></a>
