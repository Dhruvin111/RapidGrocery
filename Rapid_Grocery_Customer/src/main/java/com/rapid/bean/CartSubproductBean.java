...
public class CartSubproductBean {
	...
	public String toString() {
		return "CartSubproductBean [cartId=" + cartId + ", subproductId=" + subproductId + ", userMasterId="
				+ userMasterId + ", quantity=" + quantity + ", totalAmount=" + totalAmount + ", subproductName="
				+ subproductName + ", subproductImage=" + subproductImage + ", subproductPrice=" + subproductPrice
				+ ", subproductQuantity=" + subproductQuantity + ", subproductDescription=" + subproductDescription
				+ "]";
	}	
